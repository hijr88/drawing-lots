...
public class victoryActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mp = MediaPlayer.create(this,R.raw.bororong);
        mp.start();

        int character[] = {R.drawable.g_victory1,R.drawable.g_victory2,R.drawable.g_victory3,
                R.drawable.g_victory4, R.drawable.g_victory5,R.drawable.g_victory6,
                R.drawable.g_victory7};
        int random_image = (int) (Math.random() * character.length);
        ImageView victory_img = (ImageView)findViewById(R.id.victory_img);
        GlideDrawableImageViewTarget gifImage;
        gifImage = new GlideDrawableImageViewTarget(victory_img);
        ...
        TextView name = (TextView)findViewById(R.id.victory_name);
